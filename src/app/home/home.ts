...
export class HomeComponent {
    ...
    onSubmit() {
        if (this.contactForm.valid) {
            ...
            // We will handle the toaster via a service or by emitting an event if needed, 
            // but for now let's keep it simple or move toaster logic here too if it's home only.
            // Since it was in App, I'll assume it's global.
